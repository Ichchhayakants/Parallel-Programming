...
int main()
{
	int Array[100],N=100,i,j,rank,size,chunk_size,pivot,send_count[100],rec[100],gp[100];
int lp[100],m,m1,cgp=0,clp=0,c1=0,c2=0,count1=0,count2=0,lessp[100],grep[100],p1,p2,n1=0,n2=0,recl[100],recg[100],r[100],rg[100];
	long int seed;
int num=10000;
	FILE *fp;
	MPI_Init(NULL,NULL);
	...
	if(rank==0)
	{
      ...
      /*	if(rank>1)
      	{
      		printf("\t Greater than pivot element Data on Processor %d\n",rank);	
       	 	for(i=0;i<c2;i++)
        	{
        		printf("%d\n",gp[i]);
        	}
        ...
        {
        	printf("\t Less than Pivot element Data on Processor %d\n",rank);
        	for(i=0;i<c1;i++)
        	{
        		printf("%d\n",lp[i]);
        	}
